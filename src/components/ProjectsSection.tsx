  ...
  return (
    <section id="projects" className="section-padding">
      <div className="container-narrow">
        ...
        <ScrollReveal>
          <div className="grid md:grid-cols-2 rounded-2xl border border-border overflow-hidden mb-5 group cursor-pointer hover:border-primary/30 hover-glow gradient-border-hover transition-all duration-400">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-5">
          {[
            ...
            <ScrollReveal key={item.client} delay={i * 0.1}>
              <div className="group border border-border rounded-2xl p-8 hover:bg-card/60 hover:border-primary/20 hover-glow gradient-border-hover transition-all duration-400 cursor-pointer flex flex-col gap-2 hover:-translate-y-1">
