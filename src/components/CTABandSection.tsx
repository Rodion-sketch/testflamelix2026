    ...
    <section className="section-padding section-dark">
      <div className="container-narrow">
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 text-sm font-medium hover:opacity-90 transition-opacity rounded-full group shrink-0"
          >
            {t("cta.btn")}
