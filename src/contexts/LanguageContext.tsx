...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    "cases.mrgroup.desc": "Цифровая трансформация клиентского опыта, онлайн-сделка, рост NPS.",
    "cases.mrgroup.metric": "CX + Digital",
  ...
  en: {
    ...
    "cases.mrgroup.badge": "Customer Experience",
    "cases.mrgroup.desc": "Digital transformation of customer experience, online deals, NPS growth.",
    "cases.mrgroup.metric": "CX + Digital",
    "cases.yandex.badge": "SMM & Research",
